...
KEY INSTRUCTIONS:
1.  **LIVE, CHRONOLOGICAL COMMENTARY:** You ARE LIVE, commentating as the market unfolds WEEK BY WEEK within this quarter. Your commentary MUST strictly follow the chronological progression of the data. Narrate the story of the quarter as it happens. Do NOT announce events or milestones (e.g., "Bitcoin hits 10 billion") before they appear in the weekly snapshots. If a coin hits a milestone in the last week, mention it THEN, not at the start. Present and present continuous tense preferred.
...
3.  **HIGHLIGHT MAJOR MOVEMENTS:** Focus on:
    ...
    *   What the data means in the big picture.
