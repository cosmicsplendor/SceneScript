...
export const SoccerSize: React.FC<SoccerSizeProps> = ({
    ...
    data = [
        ...
        { date: "2010", data: [{ name: "Messi", value: 2 }, { name: "Ronaldo", value: 1 }] },
        { date: "2011", data: [{ name: "Messi", value: 3 }, { name: "Ronaldo", value: 1 }] },
        { date: "2012", data: [{ name: "Messi", value: 4 }, { name: "Ronaldo", value: 1 }] },
        { date: "2013", data: [{ name: "Messi", value: 4 }, { name: "Ronaldo", value: 2 }] },
        { date: "2014", data: [{ name: "Messi", value: 4 }, { name: "Ronaldo", value: 3 }] },
        { date: "2015", data: [{ name: "Messi", value: 5 }, { name: "Ronaldo", value: 3 }] },
        { date: "2016", data: [{ name: "Messi", value: 5 }, { name: "Ronaldo", value: 4 }] },
        { date: "2017", data: [{ name: "Messi", value: 5 }, { name: "Ronaldo", value: 5 }] },
        { date: "2019", data: [{ name: "Messi", value: 6 }, { name: "Ronaldo", value: 5 }] },
        { date: "2021", data: [{ name: "Messi", value: 7 }, { name: "Ronaldo", value: 5 }] },
        { date: "2023", data: [{ name: "Messi", value: 8 }, { name: "Ronaldo", value: 5 }] }
    ],
    ...
    // Image Mappers
    imageMappers = {
        Messi: (value) => staticFile(`images/mess${value + 1 || 1}.png`),
        Ronaldo: (value) => staticFile(`images/ron${value + 1 || 1}.png`),
    },
