...
export const TransferMarket: React.FC = () => <AbsoluteFill>
  ...
  <StandaloneLottie animationData={alert} startFrame={0} loop={false} durationInSeconds={0.6} target="BullHead" width={300} offsetX={-0} offsetY={-1} filter="brightness(1.2)" />
