...
export const TransferMarket: React.FC = () => <AbsoluteFill>
  ...
  <StandaloneLottie animationData={alert} startFrame={542} loop={false} durationInSeconds={1} target="agressiveWolf" width={500} offsetX={0.5} offsetY={-0.5} filter="brightness(1.2)" />
